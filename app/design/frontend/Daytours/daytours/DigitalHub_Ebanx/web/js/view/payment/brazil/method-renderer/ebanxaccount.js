define(
    [
        ...
        'Daytours_Checkout/js/payment-method-selected'
    ],
    function (
        _,
        Component,
        ...
        return Component.extend({
            ...
            getFormTemplate: function(){
                return 'DigitalHub_Ebanx/payment/brazil/ebanxaccount/form'
            },
            ...
            isActive: function () {
                paymentSelected.removeAttrForToPaymentMethods();
                return true;
            },
            ...
            getMethodConfig: function() {
                return window.checkoutConfig.payment.digitalhub_ebanx_brazil_ebanxaccount
            },
