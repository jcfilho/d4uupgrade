...
class EditInterval extends \Magento\Framework\App\Action\Action
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        $htmlCalendarForm = $this->_view->getLayout()->createBlock('Magebay\Bookingsystem\Block\Marketplace\Calendars')->setData($dataSend)->setTemplate('Magebay_Bookingsystem::marketplace/calendars/interval-form.phtml')->toHtml();
