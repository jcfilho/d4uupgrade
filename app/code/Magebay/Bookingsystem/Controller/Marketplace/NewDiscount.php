...
class NewDiscount extends Action
{
	...
	public function execute()
	{
		...
		$htmlDiscount = $this->_view->getLayout()->createBlock('Magebay\Bookingsystem\Block\Marketplace\Booking')->setTemplate('Magebay_Bookingsystem::marketplace/form-discount.phtml')->toHtml();
		if($kindOfDicount == 'hotel')
		{
			$htmlDiscount = $this->_view->getLayout()->createBlock('Magebay\Bookingsystem\Block\Marketplace\Booking')->setTemplate('Magebay_Bookingsystem::marketplace/rooms/form-discount.phtml')->toHtml();
		}
