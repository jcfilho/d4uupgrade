...
class NewOption extends Action
{
	...
	public function execute()
	{
		...
		$htmlOptions = $this->_view->getLayout()->createBlock('Magebay\Bookingsystem\Block\Marketplace\Booking')->setTemplate('Magebay_Bookingsystem::marketplace/form-options.phtml')->toHtml();
		if($kindOfOption == 'hotel')
		{
			$htmlOptions = $this->_view->getLayout()->createBlock('Magebay\Bookingsystem\Block\Marketplace\Booking')->setTemplate('Magebay_Bookingsystem::marketplace/rooms/form-options.phtml')->toHtml();
		}
