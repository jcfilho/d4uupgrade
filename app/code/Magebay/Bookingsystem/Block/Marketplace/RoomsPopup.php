...
class RoomsPopup extends Template
{
	...
	**/
	...
	{
		$urlSaveRoom = $this->_bkHelperText->formatUrlPro($this->getUrl('bookingsystem/marketplace/SaveRoom'));
		$urlEditRoom = $this->_bkHelperText->formatUrlPro($this->getUrl('bookingsystem/marketplace/setupRoom'));
		$urlDellRoom = $this->_bkHelperText->formatUrlPro($this->getUrl('bookingsystem/marketplace/deleteRoom'));
		$newOptionUrl = $this->_bkHelperText->formatUrlPro($this->getUrl('bookingsystem/marketplace/newOption'));
		$newDiscountUrl = $this->_bkHelperText->formatUrlPro($this->getUrl('bookingsystem/marketplace/NewDiscount'));
		$urlUploadImage = $this->_bkHelperText->formatUrlPro($this->getUrl('bookingsystem/marketplace/uploadImage'));
		$urlDeleteImage = $this->_bkHelperText->formatUrlPro($this->getUrl('bookingsystem/marketplace/deleteImage'));
		return array(
