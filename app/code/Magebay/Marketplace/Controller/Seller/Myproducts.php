...
class Myproducts extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function execute()
    {
        ...
        if($isseller){
    		...
    		$resultPageFactory->getConfig()->getTitle()->set(__('My Products List'));	
    		if($breadcrumbs = $resultPageFactory->getLayout()->getBlock('breadcrumbs')){
                ...
                $breadcrumbs->addCrumb('market_menu_product_list',
                    [
                        'label' => __('My Products List'),
                        'title' => __('My Products List')
                    ]
                ); 
            }
