...
class Mytransactions extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function execute()
    {
        ...
        if($isseller){	
    		...
    		$resultPageFactory->getConfig()->getTitle()->set(__('Withdrawals'));	
    		if($breadcrumbs = $resultPageFactory->getLayout()->getBlock('breadcrumbs')){
                ...
                $breadcrumbs->addCrumb('market_menu_transaction_list',
                    [
