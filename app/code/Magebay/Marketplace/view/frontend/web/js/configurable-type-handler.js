define([
    ...
    'Magebay_Marketplace/js/advanced-pricing-handler',
    'Magebay_Marketplace/js/options/price-type-handler',
    'collapsible',
    ...
    return {
         ...
         */
        'Magebay_Marketplace/js/configurable-type-handler': function (data) {
