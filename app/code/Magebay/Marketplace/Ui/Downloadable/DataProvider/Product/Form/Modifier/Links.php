 ...
 */
namespace Magebay\Marketplace\Ui\Downloadable\DataProvider\Product\Form\Modifier;
...
class Links extends AbstractModifier
{
    ...
    protected function getPriceColumn()
    {
        ...
        $priceField['arguments']['data']['config'] = [
            ...
            'componentType' => Form\Field::NAME,
            'dataType' => Form\Element\DataType\Number::NAME,
            'component' => 'Magebay_Marketplace/js/components/price-handler',
            'dataScope' => 'price',
    ...
    protected function getFileColumn()
    {
        ...
        $fileTypeField['arguments']['data']['config'] = [
            ...
            'componentType' => Form\Field::NAME,
            'component' => 'Magebay_Marketplace/js/components/upload-type-handler',
			'elementTmpl' => 'Magebay_Marketplace/form/element/select',
            'dataType' => Form\Element\DataType\Text::NAME,
            'dataScope' => 'type',
        ...
        $fileUploader['arguments']['data']['config'] = [
            ...
            'component' => 'Magebay_Marketplace/js/components/file-uploader',
            'elementTmpl' => 'Magebay_Marketplace/components/file-uploader',
            'fileInputName' => 'links',
            'uploaderConfig' => [
