 ...
 */
namespace Magebay\Marketplace\Ui\ConfigurableProduct\DataProvider\Product\Form\Modifier;

use Magebay\Marketplace\Ui\DataProvider\Product\Form\Modifier\AbstractModifier;
...
class ConfigurablePanel extends AbstractModifier
{
    ...
    const ASSOCIATED_PRODUCT_MODAL = 'marketplace_configurable_associated_product_modal';
    const ASSOCIATED_PRODUCT_LISTING = 'marketplace_configurable_associated_product_listing';
                            ...
                            'arguments' => [
                                'data' => [
                                    'config' => [
                                        ...
                                        'component' => 'Magebay_Marketplace/js'
                                        ...
                                        'render_url' => $this->urlBuilder->getUrl('marketplace/product_mui/render'),
                                        'realTimeLink' => true,
                                        ...
                                        'productsProvider' => $this->associatedListingPrefix
                                            . 'marketplace_configurable_associated_product_listing.data_source',
                                        'productsColumns' => $this->associatedListingPrefix
                                            . 'marketplace_configurable_associated_product_listing'
                                            . '.' . $this->associatedListingPrefix
                                            . 'marketplace_configurable_associated_product_listing.product_columns',
                                        'productsMassAction' => $this->associatedListingPrefix
                                            . 'marketplace_configurable_associated_product_listing'
                                            . '.' . $this->associatedListingPrefix
                                            . 'marketplace_configurable_associated_product_listing.product_columns.ids',
                                        'modalWithGrid' => 'ns=' . $this->formName . ', index='
                                            . static::ASSOCIATED_PRODUCT_MODAL,
                                        'productsFilters' => $this->associatedListingPrefix
                                            . 'marketplace_configurable_associated_product_listing'
                                            . '.' . $this->associatedListingPrefix
                                            . 'marketplace_configurable_associated_product_listing.listing_top.listing_filters',
                                    ],
                                ],
                            ],
                        ],
    ...
    protected function getButtonSet()
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        'component' => 'Magebay_Marketplace/js/components/container-configurable-handler',
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Magebay_Marketplace/js/components/dynamic-rows-configurable',
                        'addButton' => false,
                        'isEmpty' => true,
                        'itemTemplate' => 'record',
                        'dataScope' => 'data',
                ...
                'children' => [
                    'thumbnail_image_container' => $this->getColumn(
                        ...
                        [
                            ...
                            'component' => 'Magebay_Marketplace/js/components/configurable/file-uploader',
                            'elementTmpl' => 'Magebay_Marketplace/components/configurable/file-uploader',
                            'fileInputName' => 'image',
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'template' => 'Magebay_Marketplace/components/cell-status',
                                    'label' => __('Status'),
                                    'dataScope' => 'status',
                                ],
                            ],
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
									...
									'template' => 'Magebay_Marketplace/form/field',
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'componentType' => 'text',
                                    'component' => 'Magento_Ui/js/form/element/abstract',
                                    'template' => 'Magebay_Marketplace/components/actions-list',
                                    'label' => __('Actions'),
                                    'fit' => true,
                                    'dataScope' => 'status',
                                ],
    ...
    protected function getColumn(
        ...
        $fieldEdit['arguments']['data']['config'] = [
            ...
            'formElement' => Form\Element\Input::NAME,
			'template' => 'Magebay_Marketplace/form/field',
			'elementTmpl' => 'Magebay_Marketplace/form/element/input',
            'componentType' => Form\Field::NAME,
            'dataScope' => $name,
            'fit' => true,
        ...
        $fieldText['arguments']['data']['config'] = [
            ...
            'formElement' => Form\Element\Input::NAME,
			'template' => 'Magebay_Marketplace/form/field',
            'elementTmpl' => 'Magebay_Marketplace/components/cell-html',
            'dataType' => Form\Element\DataType\Text::NAME,
            'dataScope' => $name,
