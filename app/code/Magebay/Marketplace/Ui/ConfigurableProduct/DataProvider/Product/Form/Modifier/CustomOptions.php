...
use Magebay\Marketplace\Ui\DataProvider\Product\Form\Modifier\CustomOptions as CustomOptionsModifier;
        ...
        if ($gridPath) {
            ...
            $meta = $this->arrayManager->set(
                ...
                [
                    ...
                    'component' => 'Magebay_Marketplace/js/components/custom-options-warning',
    ...
    private function modifyPriceTypeFields(array $meta)
    {
        ...
        foreach ($paths as $fieldPath) {
            $meta = $this->arrayManager->merge(
                ...
                $meta,
                [
                    'component' => 'Magebay_Marketplace/js/components/custom-options-price-type',
                    'isConfigurable' => $isConfigurable,
