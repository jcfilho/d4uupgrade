...
class Categories extends AbstractModifier
{
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'autoRender' => false,
                                    'ns' => 'marketplacenew_category_form',
                                    'externalProvider' => 'marketplacenew_category_form.marketplacenew_category_form_data_source',
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    'formElement' => 'select',
                                    'componentType' => 'field',
                                    'component' => 'Magebay_Marketplace/js/components/new-category',
                                    'filterOptions' => true,
                                    'chipsEnabled' => true,
                                    'disableLabel' => true,
                                    'levelsVisibility' => '1',
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'actions' => [
                                        [
                                            'targetName' => 'magebaymarketproduct_form.magebaymarketproduct_form.create_category_modal',
                                            'actionName' => 'toggleModal',
                                        ],
                                        [
                                            'targetName' =>
                                                'magebaymarketproduct_form.magebaymarketproduct_form.create_category_modal.create_category',
                                            'actionName' => 'render'
                                        ],
                                        [
                                            'targetName' =>
    ...
    protected function getCategoriesTree($filter = null)
    {
        ...
        $enable_categories = explode(',',\Magento\Framework\App\ObjectManager::getInstance()->create('\Magento\Framework\App\Config\ScopeConfigInterface')->getValue('marketplace/general/categoryids', \Magento\Store\Model\ScopeInterface::SCOPE_STORE));
        foreach ($collection as $category) {
            if(!in_array($category->getId(),$enable_categories)) continue;
