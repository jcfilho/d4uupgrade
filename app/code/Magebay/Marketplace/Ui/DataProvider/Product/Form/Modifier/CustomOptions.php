            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Magebay_Marketplace/js/components/dynamic-rows-import-custom-options',
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'dataScope' => '',
                        'provider' => static::FORM_NAME . '.magebaymarketproduct_form_data_source',
                        'options' => [
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'component' => 'Magebay_Marketplace/component/static-type-input',
                                    'valueUpdate' => 'input',
                                    'imports' => [
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Magebay_Marketplace/js/custom-options-type',
						'template' => 'Magebay_Marketplace/form/field',
