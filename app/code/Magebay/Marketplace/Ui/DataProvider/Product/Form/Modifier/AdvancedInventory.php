...
use Magebay\Marketplace\Controller\Product\Initialization\StockDataFilter;
    ...
    private function prepareMeta()
    {
        ...
        if ($pathField) {
            ...
            $qty['arguments']['data']['config'] = [
                'component' => 'Magebay_Marketplace/js/components/qty-validator-changer',
            ...
            $advancedInventoryButton['arguments']['data']['config'] = [
                ...
                'template' => 'Magebay_Marketplace/components/button/container',
                'actions' => [
                    [
                        'targetName' => 'magebaymarketproduct_form.magebaymarketproduct_form.advanced_inventory_modal',
