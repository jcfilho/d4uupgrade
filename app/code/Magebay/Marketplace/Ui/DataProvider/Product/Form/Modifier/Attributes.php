    ...
    public function modifyMeta(array $meta)
    {
        ...
        if (isset($meta[static::GROUP_CODE])) {
            $meta[static::GROUP_CODE]['arguments']['data']['config']['component'] =
                'Magebay_Marketplace/js/components/attributes-fieldset';
        }
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'actions' => [
                                        [
                                            'targetName' => 'magebaymarketproduct_form.magebaymarketproduct_form.add_attribute_modal'
                                                . '.create_new_attribute_modal',
                                            'actionName' => 'toggleModal',
                                        ],
                                        [
                                            'targetName'
                                            => 'magebaymarketproduct_form.magebaymarketproduct_form.add_attribute_modal'
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'formProvider' => 'ns = ${ $.namespace }, index = magebaymarketproduct_form',
