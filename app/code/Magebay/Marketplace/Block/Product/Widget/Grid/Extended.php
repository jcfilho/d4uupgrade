...
class Extended extends \Magebay\Marketplace\Block\Product\Widget\Grid 
{
    /**
     * Columns array
     * @var array
     ...
     * @var string
     */
    protected $_massactionBlockName = 'Magebay\Marketplace\Block\Product\Widget\Grid\Massaction\Extended';
     ...
     * @var string
     */
    protected $_template = 'Magebay_Marketplace::product/widget/grid/extended.phtml';
    ...
    protected function _prepareLayout()
    {
        $this->setChild(
            'export_button',
            $this->getLayout()->createBlock('Magebay\Marketplace\Block\Product\Widget\Button')->setData(
                [
                    'label' => __('Export'),
    ...
    public function getColumnSet()
    {
        if (!$this->getChildBlock('grid.columnSet')) {
            $this->setChild(
                'grid.columnSet',
                $this->getLayout()->createBlock('Magebay\Marketplace\Block\Product\Widget\Grid\ColumnSet')
            );
        }
    ...
    public function addColumn($columnId, $column)
    {
        if (is_array($column)) {
            $this->getColumnSet()->setChild(
                $columnId,
                $this->getLayout()
                    ->createBlock('Magebay\Marketplace\Block\Product\Widget\Grid\Column\Extended')
                    ->setData($column)
                    ->setId($columnId)
                    ->setGrid($this)
            );
    ...
    protected function _prepareMassactionColumn()
    {
        ...
        $massactionColumn = $this->getLayout()
            ->createBlock('Magebay\Marketplace\Block\Product\Widget\Grid\Column')
            ->setData(
                [
