<?php
namespace Magebay\Marketplace\Block\Product\Widget\Grid;

use Magebay\Marketplace\Block\Product\Widget\Grid\Filter\AbstractFilter;

class Column extends \Magebay\Marketplace\Block\Product\Widget
{
    /**
     * Parent grid
     *
     * @var \Magebay\Marketplace\Block\Product\Widget\Grid
     */
    protected $_grid;
     ...
     * Column renderer
     *
     * @var \Magebay\Marketplace\Block\Product\Widget\Grid\Renderer\AbstractRenderer
     */
    protected $_renderer;
    ...
    protected $_rendererTypes = [
        'checkbox' => 'Magebay\Marketplace\Block\Product\Widget\Grid\Renderer\Checkbox',
		'text' => 'Magebay\Marketplace\Block\Product\Widget\Grid\Renderer\Longtext',
		'currency' => 'Magebay\Marketplace\Block\Product\Widget\Grid\Renderer\Currency',
        'default' => 'Magebay\Marketplace\Block\Product\Widget\Grid\Renderer\Text',
    ];
    ...
    protected $_filterTypes = [
        'range' => 'Magebay\Marketplace\Block\Product\Widget\Grid\Filter\Range',
        'number' => 'Magebay\Marketplace\Block\Product\Widget\Grid\Filter\Range',
        'currency' => 'Magebay\Marketplace\Block\Product\Widget\Grid\Filter\Range',
        'skip-list' => 'Magebay\Marketplace\Block\Product\Widget\Grid\Filter\SkipList',
        'default' => 'Magebay\Marketplace\Block\Product\Widget\Grid\Filter\Text',
    ];
     ...
     *
     * @param \Magebay\Marketplace\Block\Product\Widget\Grid $grid
     * @return $this
     */
     ...
     * Get grid block
     *
     * @return \Magebay\Marketplace\Block\Product\Widget\Grid
     */
     ...
     * Set column renderer
     *
     * @param \Magebay\Marketplace\Block\Product\Widget\Grid\Renderer\AbstractRenderer $renderer
     * @return $this
     */
     ...
     *
     * @return \Magebay\Marketplace\Block\Product\Widget\Grid\Renderer\AbstractRenderer
     */
