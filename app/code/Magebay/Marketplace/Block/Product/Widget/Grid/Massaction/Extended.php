...
namespace Magebay\Marketplace\Block\Product\Widget\Grid\Massaction;

class Extended extends \Magebay\Marketplace\Block\Product\Widget
{
    /**
     * Massaction items
     *
     ...
     * @var string
     */
    protected $_template = 'Magebay_Marketplace::product/widget/grid/massaction_extended.phtml';
