...
namespace Magebay\Marketplace\Block\Product\Widget\Grid\Renderer;

class Checkbox extends \Magebay\Marketplace\Block\Product\Widget\Grid\Renderer\AbstractRenderer
{
    /**
     * @var int
     */
    ...
    protected function _getCheckboxHtml($value, $checked)
    {
        ...
        $html .= 'class="' .
            ...
            ' magebay__control-checkbox' . '"';
        $html .= $checked . $this->getDisabled() . '/>';
        $html .= '<label for="id_' . $this->escapeHtml($value) . '"></label>';
        $html .= '</label>';
        /* ToDo UI: add class="magebay__field-label" after some refactoring _fields.less */
        return $html;
    }
    ...
    public function renderHeader()
    {
        ...
        $html .= 'class="magebay__control-checkbox"' . $checked . $disabled . ' ';
