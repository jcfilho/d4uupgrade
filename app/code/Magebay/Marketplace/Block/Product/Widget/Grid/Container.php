...
class Container extends \Magebay\Marketplace\Block\Product\Widget\Container
{
    /**#@+
     ...
     * @var string
     */
    protected $_blockGroup = 'Magebay_Marketplace';

    /**
     * @var string
     */
    protected $_template = 'Magebay_Marketplace::product/widget/grid/container.phtml';
