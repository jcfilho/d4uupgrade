...
namespace Magebay\Marketplace\Block\Product\Bundle;

use Magento\Framework\Data\Form\Element\AbstractElement;

class Option extends \Magebay\Marketplace\Block\Product\Widget
{
    /**
     * Form element
     *
     ...
     * @var string
     */
    protected $_template = 'Magebay_Marketplace::product/bundle/option.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addChild(
            'selection_template',
            'Magebay\Marketplace\Block\Product\Bundle\Selection'
        );
