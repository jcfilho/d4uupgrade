...
class Bundle extends \Magebay\Marketplace\Block\Product\Widget
{
    /**
     * @var mixed
     */
     ...
     * @var string
     */
    protected $_template = 'Magebay_Marketplace::product/bundle/bundle.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            ...
            $this->getLayout()->createBlock(
                'Magebay\Marketplace\Block\Product\Bundle\Option',
