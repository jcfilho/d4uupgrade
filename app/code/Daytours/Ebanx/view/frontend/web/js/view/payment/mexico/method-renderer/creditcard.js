    ...
    function (
        ...
        return Component.extend({
            ...
            initialize: function() {
                ...
                $.when(installments()).done(function (result) {
                    ...
                    _.forEach(result.installments, function(item){
                        if([1,3,6,9,12].indexOf(item.number) != -1){
            ...
            getFormTemplate: function(){
                return 'DigitalHub_Ebanx/payment/mexico/creditcard/form'
            },
            ...
            getMethodConfig: function() {
                return window.checkoutConfig.payment.digitalhub_ebanx_mexico_creditcard
            },
