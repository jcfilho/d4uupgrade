...
class Edit extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Daytours_Provider::save';
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Daytours4u_Provider::provider')
            ->addBreadcrumb(__('Provider'), __('Provider'))
            ->addBreadcrumb(__('Manage Providers'), __('Manage Providers'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('booking_provider', $model);
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getTitle() : __('New Provider'));
