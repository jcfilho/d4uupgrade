    ...
    public function moveAllToCart(\Magento\Wishlist\Model\Wishlist $wishlist, $qtys)
    {
        ...
        foreach ($collection as $item) {
            ...
            try {
                ...
                $options = $this->optionFactory->create()->getCollection()->addItemFilter([$item->getId()]);
                $item->setOptions($options->getOptionsByItem($item->getId()));
                // Add to cart
                $this->helperWishlist->setOptionsFromWishlistAddToCart($options->getOptionsByItem($item->getId()),$item->getProductId());
