define(
    ...
    function($, alert, confirm){
      ...
      app.prototype = {
        ...
        config                : {},
        selectors:  {
          btnAddNewLockedDate   : '#block-date-calendar-two',
          btnAddNewDate         : '#add-new-calendar-two',
          btnDeleteLocked       : 'body .items-locked .item-locked .remove',
          btnSaveNewLockedDate  : 'body #save-new-locked-date-two',
          containerRight        : '#form-booking-calendar-two',
          containerCalendar     : '.booking-popup-content .item-two #booking-calendar-two',
          inputDateToBlock      : 'body #item-day-locked-two',
        },
        ...
        init: function (config) {
          ...
          /*
          config : {
            urlToLoadLockedDates, urlToSaveLockedDates ,urlToDeleteLockedDates, productId, currentDate, formatDate, calendarNumber
        ...
        _loadListLockedDates: function(){
          ...
          $.ajax({
            ...
            data: {
              ...
              calendarNumber : self.config.calendarNumber,
            },
            type: "GET",
            dataType: 'json'
          }).done(function(data){
        ...
        _reloadCalendar: function(){
          let self = this;
          let objData = $(self.selectors.containerCalendar).data('objDataTwo');
          console.log(objData);
          $(self.selectors.containerCalendar).MagebayAnyBookingTwo(objData);
        }
