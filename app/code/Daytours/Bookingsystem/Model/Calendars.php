...
class Calendars extends \Magebay\Bookingsystem\Model\Calendars
{
	/**
    ...
    )
    {
        ...
        parent::__construct($date,$timezone,$bkHelperDate,$context, $registry, $resource, $resourceCollection, $data);
    }
	...
	function saveBkCalendars($params,$bkStore = true)
    {
        ...
        $dataSave = array(
            ...
            'calendar_number' => $params['calendar_number'],
        );
        if ($okCalendar == 1) {
	...
	* return $item
	*/
    function getCalendarBetweenDays($bookingId,$strDay,$bookingType = 'per_day',$calendarNumber = 1)
    {
        $arrayseletct = array('*');
        $conditions = array('calendar_number' => $calendarNumber);
