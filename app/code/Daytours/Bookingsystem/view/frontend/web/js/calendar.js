define([
    ...
    $.fn.MagebayAnyBooking = function(objData)
    {
        ...
        methods = {
            ...
            {
                //$('.item-one .booking-item-day').off('click');
                $('body .item-one').on('click','.booking-item-day',function(){
                    ...
                    $('#check-in').val(startDate1);
                    $('#check-out').val(endDate1);
                    if(bkSimpleDate == 2)
                    {
                        $('#bk-checkin-checkout').val(startDate1 +' - '+ endDate1);
                    }
                    else
                    {
                        $('#bk-checkin-checkout').val(startDate1);
                    }
                    dayClick = '';
                ...
                if(bkSimpleDate == 2)
                {
                    $( ".item-one .booking-item-day" ).hover(
                        function() {
                            var strDayId = $(this).attr('id');
                            var arDayId = strDayId.split('_');
                            var strDateId = arDayId[1];
